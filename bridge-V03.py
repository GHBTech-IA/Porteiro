# NeuralGuard Engine v8.4 - Estabilidade Total
import cv2
import time
import os
import base64
...
@app.route('/snapshot')
def get_frame():
    if last_frame is None: return "Aguardando camera...", 503
...
if __name__ == "__main__":
    print(">>> ENGINE v8.4 ATIVA")
    print(">>> FLASK RODANDO EM: http://0.0.0.0:5050")
